    ...
    render() {
        ...
        return (
            <div className='user-redux-container'>
                <div className='title'>
                    <div className="text-center" >Manage redux</div>
                </div>
                ...
                <div className='user-redux-body'>
                    <div className='container'>
                        <div className='row'>
                            ...
                            <div className='col-12'>{isGetGender !== true || isGetPosition !== true || isGetRole !== true ? 'loading data' : ''}</div>
                            <div className='col-3'>
